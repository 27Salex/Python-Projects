...
async def on_message(message):
    ...
    elif message.content.startswith("m-help"): #Si el mensaje enviado empieza con "m-help"
        await message.channel.send("Here are some commands you can use: m-help,  /dice, /hola, /hug, /play")
